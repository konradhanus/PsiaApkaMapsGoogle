...
//			}
			...
			string target = proj.GetUnityFrameworkTargetGuid(); // Updated this line	
			...
			ProjectCapabilityManager capabilities = new ProjectCapabilityManager(projPath, entitlementsPath, target);
