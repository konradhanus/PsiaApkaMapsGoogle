...
public class HealthKitFullTest : MonoBehaviour {
	...
	public void ReadData() {
		...
		if (!reading) {
			...
			try {
				...
				DateTimeOffset start = now.AddDays(-2);
	...
	*/
	...
	public void ReadStatistics() {
			...
			healthStore.ReadStatistics(HKDataType.HKQuantityTypeIdentifierStepCount, start, end, StatisticsOptions.SeparateBySource, (statistics, error) => {
			string str = "";
