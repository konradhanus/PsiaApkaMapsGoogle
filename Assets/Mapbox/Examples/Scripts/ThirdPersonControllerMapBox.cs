...
#endif
    public class ThirdPersonControllerMapBox : MonoBehaviour
    {
        [Header("Player")]
        ...
        private void Move()
        {
            ...
            // Debug.Log("ARROWS:"+(targetDirection.normalized * (_speed * Time.deltaTime) + new Vector3(0.0f, _verticalVelocity, 0.0f) * Time.deltaTime));

            
				

             if (_isInitialized && Grounded)
			{
                ...
                // Debug.Log("Speed delta: " + speed*Time.deltaTime);
                // Debug.Log("Speed devide"+ speed/smoothSpeed);
                // Debug.Log("Speed devide delta"+ speed/(smoothSpeed*Time.deltaTime));
                // Debug.Log("Speed multiplay "+ speed*(smoothSpeed));
                // Debug.Log("Speed multiplay delta"+ speed*(smoothSpeed*Time.deltaTime));

                
                Vector3 smoothedPosition = Vector3.Lerp(transform.position, newPosition, smoothSpeed * Time.deltaTime);
                _controller.Move(smoothedPosition - transform.position);
